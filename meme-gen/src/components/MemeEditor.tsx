...
const characterImages = [
    ...
    `${process.env.PUBLIC_URL}/wojak/afterpain.png`,
    `${process.env.PUBLIC_URL}/wojak/chad.png`,
    `${process.env.PUBLIC_URL}/wojak/itsover.png`,
    `${process.env.PUBLIC_URL}/wojak/mask.png`,
    `${process.env.PUBLIC_URL}/wojak/midlife.png`,
    `${process.env.PUBLIC_URL}/wojak/pain.png`,
    `${process.env.PUBLIC_URL}/wojak/retord.png`,
    `${process.env.PUBLIC_URL}/wojak/smug.png`,
    `${process.env.PUBLIC_URL}/wojak/smug_og.png`,
    `${process.env.PUBLIC_URL}/wojak/this_guy.png`,
    `${process.env.PUBLIC_URL}/wojak/wojak.png`,
    `${process.env.PUBLIC_URL}/wojak/wojakrage.png`,
    `${process.env.PUBLIC_URL}/wojak/youcant.png`,
